...
<div class="flex mx-auto justify-start pl-20 pt-20">
    <h1 class=" title-font font-bold text-2xl sm:text-3xl md:text-3xl lg:text-3xl xl:text-3xl">Add Task</h1>
</div>
            ...
            <div class="card-body">
                ...
                <form on:submit|preventDefault={submit(task)}>
                    ...
                    <div class="w-2/3">
                        ...
                        <textarea bind:value={task.description} class="textarea textarea-bordered h-24 w-2/3" maxlength="250" placeholder="Description"></textarea>
                        <label class="label">
